# Leviculum Architecture — Driver & Internals Reference

For module responsibilities, layer rules, interface tables, and coding
covers driver-writing internals and packet flow details.
