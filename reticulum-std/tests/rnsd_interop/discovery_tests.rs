...
use reticulum_core::constants::{ED25519_KEY_SIZE, MTU, TRUNCATED_HASHBYTES, X25519_KEY_SIZE};
...
///
/// Captures sent packets and provides a simple interface for testing.
...
impl MockInterface {
    fn new(name: &str) -> Self {
        // Generate a unique hash for this interface
